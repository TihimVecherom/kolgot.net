        ...
        function initSliders() {
            if (document.querySelector(".swiper")) {
                ...
                new core(".recommended-swiper", {
                    ...
                    speed: 800,
                    navigation: {
                        prevEl: ".recommended-btn-prev",
                        nextEl: ".recommended-btn-next"
                    },
                    breakpoints: {
                        320: {
                            slidesPerView: 1,
...
***************************************************************************** */
        ...
        const mainBgMb = document.querySelector("body");
        if (menuBurger) menuBurger.addEventListener("click", (function(e) {
            ...
            if (mainBgMb) mainBgMb.classList.toggle("_active-after-mb");
        }));
        const elNodes = document.querySelectorAll(".item-btn-mb");
        let activeBtn = null;
        if (window.innerWidth < 991) elNodes.forEach((el => {
            el.addEventListener("click", (() => {
                const isActive = el.classList.contains("_btn-active");
                if (isActive) {
                    el.classList.remove("_btn-active");
                    activeBtn = null;
                } else {
                    if (activeBtn) activeBtn.classList.remove("_btn-active");
                    el.classList.add("_btn-active");
                    activeBtn = el;
                }
            }));
        }));
        ...
        accordionContent.forEach(((item, index) => {
            let header = item.querySelector(".accordion__title");
            header.addEventListener("click", (() => {
                item.classList.toggle("open");
                let description = item.querySelector(".accordion__text");
                if (item.classList.contains("open")) {
                    description.style.height = `${description.scrollHeight}px`;
                    item.querySelector("i").classList.replace("i-plus", "i-minus");
                } else {
                    description.style.height = "0px";
                    item.querySelector("i").classList.replace("i-minus", "i-plus");
                }
                removeOpen(index);
            }));
        }));
        function removeOpen(index1) {
            accordionContent.forEach(((item2, index2) => {
                if (index1 != index2) {
                    ...
                    let descr = item2.querySelector(".accordion__text");
                    descr.style.height = "0px";
                    item2.querySelector("i").classList.replace("i-minus", "i-plus");
                }
            }));
        }
        const filterBtn = document.querySelector(".filter__mb-btn");
        ...
        if (filterBtn) filterBtn.addEventListener("click", (function(e) {
            if (filterBody) filterBody.classList.add("_filter-active-mb");
            if (mainBgMb) mainBgMb.classList.add("_active-after-mb");
        }));
        if (filterBtnClose) filterBtnClose.addEventListener("click", (function(e) {
            if (filterBody) filterBody.classList.remove("_filter-active-mb");
            if (mainBgMb) mainBgMb.classList.remove("_active-after-mb");
        }));
        window["FLS"] = true;
        isWebp();
        spollers();
